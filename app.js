...
class ProfessionalEarthquakeMonitor {
    ...
    updateEarthquakeDisplay() {
        ...
        this.earthquakeHistory.forEach(eq => {
            ...
            itemDiv.addEventListener('click', () => selectEarthquake(eq.id));
    ...
    showIntensityPopup(earthquake) {
        ...
        const header = `
            <div class="popup-header">
                <h3 class="popup-title">🌏 地震詳細情報</h3>
                        <button id="popup-close-intensity" class="popup-close">×</button>
            </div>
        `;
        ...
        // イベントリスナーを設定
        document.getElementById('popup-close-intensity').addEventListener('click', () => this.closeIntensityPopup());
        document.getElementById('intensity-popup-overlay').addEventListener('click', () => this.closeIntensityPopup());
    ...
    showSettingsPanel() {
        ...
        panel.innerHTML = `
            <div class="settings-header">
                ...
                <button id="settings-close-btn" class="popup-close">×</button>
            </div>

            <div class="settings-section">
                <div id="toggle-activity-feed" class="settings-section-title" style="cursor: pointer;">
                    <span>📋</span>
                    アクティビティフィード
            ...
            <div class="settings-section">
                <div id="toggle-brightness-settings" class="settings-section-title" style="cursor: pointer;">
                    <span>🔆</span>
                    表示調整
                ...
                <div class="brightness-settings" id="settings-brightness" style="display: none;">
                    <div class="setting-item">
                        ...
                        <div class="brightness-presets" style="margin-top: 8px; display: flex; gap: 8px;">
                            <button id="preset-brightness-dark" class="preset-btn" style="padding: 4px 8px; background: #2d3748; color: white; border: 1px solid #4a5568; border-radius: 4px; cursor: pointer;">暗め</button>
                            <button id="preset-brightness-normal" class="preset-btn" style="padding: 4px 8px; background: #2d3748; color: white; border: 1px solid #4a5568; border-radius: 4px; cursor: pointer;">標準</button>
                            <button id="preset-brightness-light" class="preset-btn" style="padding: 4px 8px; background: #2d3748; color: white; border: 1px solid #4a5568; border-radius: 4px; cursor: pointer;">明るめ</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="settings-section">
                <div id="toggle-notification-settings" class="settings-section-title" style="cursor: pointer;">
                    <span>🔔</span>
                    通知設定
                ...
                <div class="notification-settings" id="settings-notification" style="display: none;">
                    <div class="setting-item">
                        ...
                        <div class="setting-input-group">
                            ...
                            <span id="magnitude-value" class="setting-value">M${this.settings.magnitudeThreshold.toFixed(1)}</span>
                        </div>
                    </div>
                    <div class="setting-item">
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-input-group">
                            ...
                            <span id="auto-zoom-value" class="setting-value">${this.settings.autoZoom ? '有効' : '無効'}</span>
                        </div>
                    </div>
                    <div class="setting-item">
                        <button id="test-notification-btn" class="test-button">🔔 通知テスト</button>
                        <button id="test-sound-btn" class="test-button">🔊 音声テスト</button>
                    </div>
                    <div class="setting-item">
                        <button id="test-tsunami-advisory" class="test-button">🌊 津波注意報テスト</button>
                        <button id="test-tsunami-warning" class="test-button">⚠️ 津波警報テスト</button>
                        <button id="test-tsunami-major-warning" class="test-button">🚨 大津波警報テスト</button>
                    </div>
                    <div class="setting-item">
                        <button id="stop-all-sounds-btn" class="test-button" style="background: linear-gradient(135deg, #ff4757 0%, #c44569 100%);">🔇 全音声停止</button>
                    </div>
                </div>
            </div>

            <div class="settings-section">
                <div id="toggle-test-tools" class="settings-section-title" style="cursor: pointer;">
                    <span>🧪</span>
                    テストツール・診断
                ...
                <div class="test-tools-settings" id="settings-test-tools" style="display: none;">
                    <div class="setting-item">
                        ...
                        <div class="test-tools-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
                            <button id="open-test-tool" class="test-tool-btn" style="padding: 12px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                <span>🧪</span>
                            ...
                            <button id="open-websocket-test-tool" class="test-tool-btn" style="padding: 12px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                <span>🔌</span>
                                <div style="text-align: left;">
                            ...
                            <button id="open-audio-test-tool" class="test-tool-btn" style="padding: 12px; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                <span>🔊</span>
                                <div style="text-align: left;">
                            ...
                            <button id="open-cors-test-tool" class="test-tool-btn" style="padding: 12px; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); color: #2d3748; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                <span>🌐</span>
                                <div style="text-align: left;">
                    ...
                    <div class="setting-item">
                        ...
                        <div style="display: flex; gap: 8px; margin-top: 8px; flex-wrap: wrap;">
                            <button id="refresh-system-status-btn" class="quick-test-btn" style="padding: 8px 16px; background: #4a9eff; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 13px;">
                                🔄 状態更新
                            </button>
                            <button id="quick-connection-check-btn" class="quick-test-btn" style="padding: 8px 16px; background: #00d4aa; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 13px;">
                                🌐 接続テスト
                            </button>
                            <button id="quick-audio-check-btn" class="quick-test-btn" style="padding: 8px 16px; background: #ff6b6b; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 13px;">
                                🔊 音声テスト
                            </button>
                            <button id="clear-system-status-btn" class="quick-test-btn" style="padding: 8px 16px; background: #6c757d; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 13px;">
                                🗑️ クリア
                            </button>
                        </div>
                    </div>
                    <div class="setting-item">
                        ...
                        <div style="display: flex; gap: 8px; margin-top: 8px; flex-wrap: wrap;">
                            <button id="clear-error-log-btn" class="quick-test-btn" style="padding: 6px 12px; background: #dc3545; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 12px;">
                                🗑️ エラーログクリア
                            </button>
                            <button id="export-system-report-btn" class="quick-test-btn" style="padding: 6px 12px; background: #28a745; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 12px;">
                                📄 レポート出力
                            </button>
                        </div>
                    </div>
    ...
    setupSettingsPanelEventHandlers() {
        ...
        const addListener = (id, event, handler) => {
            ...
            if (element) {
                ...
                console.warn(`[CSP] Element with id '${id}' not found for event handler.`);
            }
        };

        // 閉じるボタン
        addListener('settings-close-btn', 'click', this.closeSettingsPanel);
        addListener('settings-overlay', 'click', this.closeSettingsPanel);

        // セクションの表示切り替え
        addListener('toggle-activity-feed', 'click', this.toggleActivityFeed);
        addListener('toggle-brightness-settings', 'click', this.toggleBrightnessSettings);
        addListener('toggle-notification-settings', 'click', this.toggleNotificationSettings);
        addListener('toggle-test-tools', 'click', this.toggleTestToolsSettings);

        // 明度調整
        addListener('map-brightness-slider', 'input', (e) => this.updateMapBrightness(parseInt(e.target.value)));
        addListener('preset-brightness-dark', 'click', () => this.setBrightness(70));
        addListener('preset-brightness-normal', 'click', () => this.setBrightness(100));
        addListener('preset-brightness-light', 'click', () => this.setBrightness(130));

        // 通知設定
        addListener('magnitude-threshold', 'input', (e) => {
            const value = parseFloat(e.target.value);
            document.getElementById('magnitude-value').textContent = `M${value.toFixed(1)}`;
            this.updateSetting('magnitudeThreshold', value);
        });
        addListener('intensity-threshold', 'change', (e) => this.updateSetting('intensityThreshold', parseInt(e.target.value)));
        addListener('volume-setting', 'input', (e) => {
            const value = parseInt(e.target.value);
            document.getElementById('volume-value').textContent = `${value}%`;
            this.updateSetting('volume', value);
        });
        addListener('auto-zoom', 'change', (e) => {
            const checked = e.target.checked;
            document.getElementById('auto-zoom-value').textContent = checked ? '有効' : '無効';
            this.updateSetting('autoZoom', checked);
        });

        // テストボタン
        addListener('test-notification-btn', 'click', this.testNotification);
        addListener('test-sound-btn', 'click', this.testSound);
        addListener('test-tsunami-advisory', 'click', () => this.testTsunamiAlert('advisory'));
        addListener('test-tsunami-warning', 'click', () => this.testTsunamiAlert('warning'));
        addListener('test-tsunami-major-warning', 'click', () => this.testTsunamiAlert('major_warning'));
        addListener('stop-all-sounds-btn', 'click', this.stopAllSounds);

        // テストツール起動ボタン
        addListener('open-test-tool', 'click', () => this.openTestTool('test'));
        addListener('open-websocket-test-tool', 'click', () => this.openTestTool('websocket-test'));
        addListener('open-audio-test-tool', 'click', () => this.openTestTool('audio-test'));
        addListener('open-cors-test-tool', 'click', () => this.openTestTool('cors-test'));

        // システムモニターボタン
        addListener('refresh-system-status-btn', 'click', this.refreshSystemStatus);
        addListener('quick-connection-check-btn', 'click', this.quickConnectionCheck);
        addListener('quick-audio-check-btn', 'click', this.quickAudioCheck);
        addListener('clear-system-status-btn', 'click', this.clearSystemStatus);
        addListener('clear-error-log-btn', 'click', this.clearErrorLog);
        addListener('export-system-report-btn', 'click', this.exportSystemReport);

        console.log('✅ All settings panel event handlers attached for CSP compliance.');
    }
    ...
    */
    ...
    showEvacuationGuidance() {
        ...
        guidanceOverlay.innerHTML = `
            ...
            <button id="evacuation-guidance-close-btn" style="
                background: white;
                color: #cc0000;
                border: none;
                padding: 10px 20px;
        ...
        document.getElementById('evacuation-guidance-close-btn').addEventListener('click', (e) => {
    ...
    */
    ...
    showDataDiscrepancyWarning(verification) {
        ...
        warningElement.innerHTML = `
            ⚠️ データソース間で相違を検出 - 検証中
            <button id="discrepancy-warning-close-btn" style="
                background: white;
                color: #ff9800;
                border: none;
                margin-left: 15px;
        ...
        document.getElementById('discrepancy-warning-close-btn').addEventListener('click', (e) => {
            e.target.parentElement.remove();
        });
    ...
    triggerImmediateTsunamiAlert(prediction) {
        ...
        alertOverlay.id = 'immediate-tsunami-alert-overlay';
        ...
        alertOverlay.innerHTML = `
            <div style="text-align: center; padding: 40px;">
                ...
                <button id="immediate-alert-close-btn" style="
                    background: white;
                    color: red;
                    border: none;
                    padding: 20px 40px;
        ...
        document.getElementById('immediate-alert-close-btn').addEventListener('click', () => {
            const overlay = document.getElementById('immediate-tsunami-alert-overlay');
            if (overlay) {
                overlay.remove();
            }
        });
...
function updateTsunamiDisplay(activeAreas) {
    ...
    if (activeAreas.length === 0) {
        ...
        if (tsunamiSectionTitle) {
            tsunamiSectionTitle.textContent = '✅ 津波情報なし';
            tsunamiSectionTitle.style.color = '#4CAF50';
        }

        console.log('🚫 津波注意報完全解除: パネル非表示・タイトル変更');
        ...
        // セクションタイトルを元に戻す
        if (tsunamiSectionTitle) {
            tsunamiSectionTitle.textContent = '🌊 津波警報・注意報';
            tsunamiSectionTitle.style.color = '';
        }

        console.log(`🌊 津波注意報アクティブ: ${activeAreas.length}地域`);
    }
}
...
function updateTsunamiRegionsPanel(activeAreas) {
    ...
    // アクティブな地域のみを表示 - XSS対策: 安全なDOM操作を使用
    activeAreas.forEach(feature => {
        ...
        regionName.textContent = props.AREA_NAME || '';

        // 地域情報
        const regionInfo = document.createElement('div');
        regionInfo.className = 'region-info';

        const waveHeight = document.createElement('span');
        waveHeight.className = 'wave-height';
        waveHeight.textContent = props.WAVE_HEIGHT || '1m';

        const arrivalTime = document.createElement('span');
        arrivalTime.className = 'arrival-time';
        arrivalTime.textContent = props.ARRIVAL_TIME || '既に到達と推定';

        regionInfo.appendChild(waveHeight);
        regionInfo.appendChild(arrivalTime);
        regionItem.appendChild(regionName);
        regionItem.appendChild(regionInfo);

        tsunamiRegionsContainer.appendChild(regionItem);
    });

    console.log(`🔄 リアルタイム監視パネル更新: ${activeAreas.length}地域表示`);
}
...
function selectEarthquake(id) {
    ...
    if (earthquake) {
        ...
        console.log(`📍 Selected earthquake: ${earthquake.location}`);
    }
}

// 本番環境用初期化完了
console.log('✅ ProfessionalEarthquakeMonitorクラス定義完了');
